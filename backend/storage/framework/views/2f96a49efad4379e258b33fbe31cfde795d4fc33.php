...
<?php $__env->startSection('title', settings()->website_title . ' | ' . __('words.create_photo')); ?>
...
<div class="d-flex align-items-baseline flex-wrap mr-5">
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item">
            <span class="text-muted"><?php echo e(__('words.create_photo')); ?></span>
        </li>
    </ul>
    <!--end::Breadcrumb-->
</div>
...
<?php $__env->startSection('form_action', route('photos.store')); ?>
...
<div class="card card-custom mb-2">
    <div class="card-header card-header-tabs-line">
        <div class="card-title">
            <h3 class="card-label"><?php echo e(__('words.create_photo')); ?></h3>
        </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="<?php echo e($locale . '[subtitle]'); ?>" placeholder="<?php echo e(__('words.sub_title')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old($locale . '.subtitle')); ?>">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            <div class="form-group col-6">
                ...
                <select class="form-control" id="exampleSelectd" name="project_id">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\BasketBall\backend\resources\views/admin/photos/create.blade.php ENDPATH**/ ?>