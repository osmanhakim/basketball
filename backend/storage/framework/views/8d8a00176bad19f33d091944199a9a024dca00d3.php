...
<?php $__env->startSection('title', settings()->website_title . ' | ' . __('words.show_about')); ?>
...
<div class="d-flex align-items-baseline flex-wrap mr-5">
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item">
            <span class="text-muted"><?php echo e(__('words.show_about')); ?></span>
        </li>
    </ul>
    <!--end::Breadcrumb-->
</div>
...
<div class="card card-custom card-stretch gutter-b">
    <div class="card-header card-header-tabs-line">
        <div class="card-title">
            <h3 class="card-label"><?php echo e(__('words.show_about')); ?></h3>
        </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        <div class="mb-7 bg-light p-5 rounded h-100">
                            ...
                            <p class="m-0"><?php echo e($about->translate($locale)->title); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        <div class="mb-7 bg-light p-5 rounded h-100">
                            ...
                            <p class="m-0"><?php echo e($about->translate($locale)->sub_title); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-7 bg-light p-5 rounded h-100">
                            ...
                            <?php echo $about->translate($locale)->description; ?>
    ...
    <div class="card card-custom">
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-md-4">
                    <div class="mb-7 bg-light p-5 rounded h-100">
                        ...
                        <p class="m-0"><?php echo e(formatDate($about->created_at)); ?></p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="mb-7 bg-light p-5 rounded h-100">
                        ...
                        <p class="m-0">
                            <?php echo e(formatDate($about->created_at) == formatDate($about->updated_at) ? '--' : formatDate($about->updated_at)); ?>
                ...
                <div class="col-md-4">
                    <div class="mb-7 bg-light p-5 rounded h-100">
                        ...
                        <p class="m-0"><span
                                class="badge rounded-pill text-white <?php echo e($about->status == 1 ? 'bg-success' : 'bg-danger'); ?>"><?php echo e($about->getActive()); ?></span>
                        </p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-8">
                    <a href="<?php echo e($about->image); ?>" data-toggle="lightbox" data-title="<?php echo e($about->title); ?>"
                        data-gallery="gallery">
                        <img src="<?php echo e($about->image); ?>" class="img-fluid mb-2 image-galley"
                            onerror="this.src='<?php echo e(asset('uploads/default_image.png')); ?>'" alt="about image" />
                    </a>
                </div>
            </div>
        ...
        <?php if (app('laratrust')->isAbleTo('update-abouts')) : ?>
        <div class="card-footer">
            <div class="row">
                <div class="col-4">
                    <a href="<?php echo e(route('abouts.edit', $about->id)); ?>" class="btn btn-block btn-outline-info">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\BasketBall\backend\resources\views/admin/about/show.blade.php ENDPATH**/ ?>