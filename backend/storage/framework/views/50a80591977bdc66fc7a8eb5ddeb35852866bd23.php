...
<?php $__env->startSection('title', settings()->website_title . ' | ' . __('words.edit_about')); ?>
...
<div class="d-flex align-items-baseline flex-wrap mr-5">
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item">
            <span class="text-muted"><?php echo e(__('words.edit_about')); ?></span>
        </li>
    </ul>
    <!--end::Breadcrumb-->
</div>
...
<?php $__env->startSection('form_action', route('abouts.update', $about->id)); ?>
...
<div class="card card-custom mb-2">
    <div class="card-header card-header-tabs-line">
        <div class="card-title">
            <h3 class="card-label"><?php echo e(__('words.edit_about')); ?></h3>
        </div>
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old($locale . '.title', $about->translate($locale)->title)); ?>">
...
unset($__errorArgs, $__bag); ?> "
                        ...
                        rows="4"><?php echo e(old($locale . '.description', $about->translate($locale)->description)); ?> </textarea>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\BasketBall\backend\resources\views/admin/about/edit.blade.php ENDPATH**/ ?>