...
<?php $__env->startSection('title', settings()->website_title . ' | ' . __('words.edit_slider')); ?>
...
<div class="d-flex align-items-baseline flex-wrap mr-5">
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item">
            <span class="text-muted"><?php echo e(__('words.edit_slider')); ?></span>
        </li>
    </ul>
    <!--end::Breadcrumb-->
</div>
...
<?php $__env->startSection('form_action', route('sliders.update', $slider->id)); ?>
...
<div class="card card-custom mb-2">
    <div class="card-header card-header-tabs-line">
        <div class="card-title">
            <h3 class="card-label"><?php echo e(__('words.edit_slider')); ?></h3>
        </div>
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old($locale . '.title', $slider->translate($locale)->title)); ?>">
...
unset($__errorArgs, $__bag); ?> "
                        ...
                        rows="4"><?php echo e(old($locale . '.description', $slider->translate($locale)->description)); ?> </textarea>
...
<div class="card card-custom">
    <div class="card-body">
        <div class="form-group row">
            ...
            <?php echo $__env->make('admin.components.editRadio', [
            'label' => __('words.page_1'),
            'name' => 'page_1',
            'val' => old('page_1', $slider->page_1),
            'required' => true,
            ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

            <?php echo $__env->make('admin.components.editRadio', [
            'label' => __('words.page_2'),
            'name' => 'page_2',
            'val' => old('page_2', $slider->page_2),
            'required' => true,
            ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\BasketBall\backend\resources\views/admin/sliders/edit.blade.php ENDPATH**/ ?>