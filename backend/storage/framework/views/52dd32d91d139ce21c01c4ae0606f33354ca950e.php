...
<?php $__env->startSection('title', settings()->website_title . ' | ' . __('words.edit_testimonial')); ?>
...
<div class="d-flex align-items-baseline flex-wrap mr-5">
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item">
            <span class="text-muted"><?php echo e(__('words.edit_testimonial')); ?></span>
        </li>
    </ul>
    <!--end::Breadcrumb-->
</div>
...
<?php $__env->startSection('form_action', route('testimonials.update', $testimonial->id)); ?>
...
<div class="card card-custom mb-2">
    <div class="card-header card-header-tabs-line">
        <div class="card-title">
            <h3 class="card-label"><?php echo e(__('words.edit_testimonial')); ?></h3>
        </div>
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old($locale . '.name', $testimonial->translate($locale)->name)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- <div class="col form-group">
                    <label><?php echo e(__('words.description')); ?> - <?php echo e(__('words.locale-' . $locale)); ?><span class="text-danger">
                            *
                        </span></label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                        ...
                        <input type="text" name="<?php echo e($locale . '[description]'); ?>"
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old($locale . '.description', $testimonial->translate($locale)->description)); ?>">
                        <?php $__errorArgs = [$locale . '[description]'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        <sp class="invalid-feedback" role="alert">
                            <strong><?php echo e($message); ?></strong>
                        </sp                an>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
...
unset($__errorArgs, $__bag); ?> "
                        ...
                        rows="4"><?php echo e(old($locale . '.description', $testimonial->translate($locale)->description)); ?> </textarea>
                    <?php $__errorArgs = [$locale . '[description]'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<div class="card card-custom">
    <div class="card-body">
        <div class="form-group row">
            ...
            'name' => 'status',
            'val' => old('status', $testimonial->status),
            'required' => false,
            ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\BasketBall\backend\resources\views/admin/testimonials/edit.blade.php ENDPATH**/ ?>