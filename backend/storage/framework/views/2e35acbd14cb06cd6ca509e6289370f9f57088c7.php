...
<?php $__env->startSection('title', settings()->website_title . ' | ' . __('words.courses')); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        <!--begin::Breadcrumb-->
        <h5 class="text-dark font-weight-bold my-1 mr-5"><?php echo e(__('words.courses')); ?></h5>
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            <li class="breadcrumb-item">
                <a href="<?php echo e(route('admin.home')); ?>" class="text-muted"><?php echo e(__('words.home')); ?></a>
            </li>
            <li class="breadcrumb-item">
                <span class="text-muted"><?php echo e(__('words.show_courses')); ?></span>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-5">
            <div class="card-title">
                <h3 class="card-title"><?php echo e(__('words.show_courses')); ?></h3>
            </div>
            ...
            <div class="card-toolbar">
                ...
                <div class="dropdown dropdown-inline mr-2">
                    ...
                    <a href="<?php echo e(route('courses.create')); ?>" class="btn btn-primary font-weight-bolder">
                            <span class="svg-icon svg-icon-md">
                                ...
                                <!--end::Svg Icon-->
                            </span><?php echo e(__('words.import')); ?></a>
                    <!--end::Button-->
                    <?php endif; // app('laratrust')->permission ?>

                    <a href="<?php echo e(route('courses.export')); ?>" class="btn btn-primary font-weight-bolder">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Flatten.svg-->
                        <span class="svg-icon svg-icon-md">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                 width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            ...
            <table class="table table-separate table-head-custom table-checkable" id="custom_datatable">
                ...
                <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e(formatDate($course->created_at)); ?></td>
                        <td><?php echo e(formatDate($course->created_at) == formatDate($course->updated_at) ? '--' : formatDate($course->updated_at)); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\BasketBall\backend\resources\views/admin/courses/index.blade.php ENDPATH**/ ?>