<head>
    <meta charset="utf-8" />
    <title><?php echo $__env->yieldContent('title', settings()->website_title); ?></title>
    ...
    <link href="<?php echo e(asset('dashboard/plugins/custom/datatables/datatables.bundle.css')); ?>" rel="stylesheet"
          type="text/css" />


<?php if(app()->getLocale() == 'ar'): ?>
    <!--begin::Page Vendors Styles(used by this page)-->
        <link href="<?php echo e(asset('dashboard/plugins/custom/fullcalendar/fullcalendar.bundle.rtl.css')); ?>" rel="stylesheet"
              type="text/css" />
        ...
        <link href="<?php echo e(asset('dashboard/css/themes/layout/header/base/dark.rtl.css')); ?>" rel="stylesheet"
              type="text/css" />
        <link href="<?php echo e(asset('dashboard/css/themes/layout/header/menu/dark.rtl.css')); ?>" rel="stylesheet"
              type="text/css" />
...
<?php else: ?>
    <!--begin::Page Vendors Styles(used by this page)-->
        <link href="<?php echo e(asset('dashboard/plugins/custom/fullcalendar/fullcalendar.bundle.css')); ?>" rel="stylesheet"
              type="text/css" />
        <!--end::Page Vendors Styles-->
        <!--begin::Global Theme Styles(used by all pages)-->
        <link href="<?php echo e(asset('dashboard/plugins/global/plugins.bundle.css')); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo e(asset('dashboard/plugins/custom/prismjs/prismjs.bundle.css')); ?>" rel="stylesheet"
              type="text/css" />
        <link href="<?php echo e(asset('dashboard/css/style.bundle.css')); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo e(asset('dashboard/css/pages/error/error-6.css')); ?>" rel="stylesheet" type="text/css" />
        <!--end::Global Theme Styles-->
        <!--begin::Layout Themes(used by all pages)-->
        <link href="<?php echo e(asset('dashboard/css/themes/layout/header/base/dark.css')); ?>" rel="stylesheet"
              type="text/css" />
        <link href="<?php echo e(asset('dashboard/css/themes/layout/header/menu/dark.css')); ?>" rel="stylesheet"
              type="text/css" />
    ...
    <link href="<?php echo e(asset('dashboard/css/iconpicker-1.5.0.css')); ?>" rel="stylesheet" type="text/css" />

    <?php echo $__env->yieldPushContent('scripts'); ?>
</head>
<?php /**PATH E:\BasketBall\backend\resources\views/admin/includes/theme/header.blade.php ENDPATH**/ ?>