...
<?php $__env->startSection('title', settings()->website_title . ' | ' . __('words.create_blog')); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <a href="<?php echo e(route('blog.index')); ?>" class="text-muted"><?php echo e(__('words.show_blogs')); ?></a>
            </li>
            <li class="breadcrumb-item">
                <span class="text-muted"><?php echo e(__('words.create_blog')); ?></span>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
...
<?php $__env->startSection('form_action', route('blog.store')); ?>
    ...
    <div class="card card-custom mb-2">
        <div class="card-header card-header-tabs-line">
            <div class="card-title">
                <h3 class="card-label"><?php echo e(__('words.create_blog')); ?></h3>
            </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\BasketBall\backend\resources\views/admin/blog/create.blade.php ENDPATH**/ ?>