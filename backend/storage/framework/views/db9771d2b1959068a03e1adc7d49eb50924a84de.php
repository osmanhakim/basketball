...
<?php $__env->startSection('title', settings()->website_title . ' | ' . __('words.pages')); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <span class="text-muted"><?php echo e(__('words.show_pages')); ?></span>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-5">
            <div class="card-title">
                <h3 class="card-title"><?php echo e(__('words.show_pages')); ?></h3>
            </div>
            ...
            <div class="card-toolbar">
                ...
                <div class="dropdown dropdown-inline mr-2">
                    <!--begin::Button-->
                    <?php if (app('laratrust')->isAbleTo('create-pages')) : ?>
                    <a href="<?php echo e(route('pages.create')); ?>" class="btn btn-primary font-weight-bolder">
            ...
            <table class="table table-separate table-head-custom table-checkable" id="custom_datatable">
                ...
                <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php else: ?>
                                <a href="<?php echo e($page->image); ?>"
                                   data-toggle="lightbox" data-title="<?php echo e($page->title); ?>"
                                   data-gallery="gallery">
                                    <img class="index_image" src="<?php echo e($page->image); ?>"
                        ...
                        <td><?php echo e(formatDate($page->created_at)); ?></td>
                        <td><?php echo e(formatDate($page->created_at) == formatDate($page->updated_at) ? '--' : formatDate($page->updated_at)); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\BasketBall\backend\resources\views/admin/pages/index.blade.php ENDPATH**/ ?>