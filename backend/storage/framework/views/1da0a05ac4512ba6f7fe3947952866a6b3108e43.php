...
<?php $__env->startSection('title', settings()->website_title . ' | ' . __('words.edit_service')); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <a href="<?php echo e(route('services.index')); ?>" class="text-muted"><?php echo e(__('words.show_services')); ?></a>
            </li>
            <li class="breadcrumb-item">
                <span class="text-muted"><?php echo e(__('words.edit_service')); ?></span>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
...
<?php $__env->startSection('form_action', route('services.update', $service->id)); ?>
    ...
    <div class="card card-custom mb-2">
        <div class="card-header card-header-tabs-line">
            <div class="card-title">
                <h3 class="card-label"><?php echo e(__('words.edit_service')); ?></h3>
            </div>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old($locale . '.title', $service->translate($locale)->title)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col form-group">
                            <label><?php echo e(__('words.short_description')); ?>(<?php echo e(__('words.locale-' . $locale)); ?>)<span
                                    class="text-danger">*</span></label>
                            <textarea class="form-control ckeditor <?php $__errorArgs = [$locale . '.short_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> " type="text"
                                name="<?php echo e($locale . '[short_description]'); ?>" rows="4"><?php echo e(old($locale . '.short_description', $service->translate($locale)->short_description)); ?> </textarea>
                            <?php $__errorArgs = [$locale . '[short_description]'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?> " type="text"
                                name="<?php echo e($locale . '[description]'); ?>" rows="4"><?php echo e(old($locale . '.description', $service->translate($locale)->description)); ?> </textarea>
    ...
    <div class="card card-custom">
        <div class="card-body">
            <div class="form-group row">
                <?php echo $__env->make('admin.components.icon', [
                    'label' => __('words.icon'),
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\BasketBall\backend\resources\views/admin/services/edit.blade.php ENDPATH**/ ?>