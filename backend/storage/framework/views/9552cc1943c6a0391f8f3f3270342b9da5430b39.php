...
<?php $__env->startSection('title',settings()->website_title .' | '. __('words.create_role')); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <span class="text-muted"><?php echo e(__('words.create_role')); ?></span>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card card-custom">
        <div class="card-header">
            <h3 class="card-title"><?php echo e(__('words.create_role')); ?></h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('name')); ?>" placeholder="<?php echo e(__('words.name')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('description')); ?>" placeholder="<?php echo e(__('words.description')); ?>">
                                            ...
                                            <span class="switch switch-icon">
                                                <label>
                                                    <input type="checkbox" id="<?php echo e($value . '-' . $key); ?>"
                                                           name="permissions[]" value="<?php echo e($value . '-' . $key); ?>"/>
                                                    <span></span>
                                                </label>
                                            </span>
                                            </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\BasketBall\backend\resources\views/admin/roles/create.blade.php ENDPATH**/ ?>