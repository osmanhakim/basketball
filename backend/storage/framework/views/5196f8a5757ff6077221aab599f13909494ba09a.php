...
<?php $__env->startSection('title', settings()->website_title . ' | ' . __('words.edit_photo')); ?>
...
<div class="d-flex align-items-baseline flex-wrap mr-5">
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item">
            <span class="text-muted"><?php echo e(__('words.edit_photo')); ?></span>
        </li>
    </ul>
    <!--end::Breadcrumb-->
</div>
...
<?php $__env->startSection('form_action', route('photos.update', $photo->id)); ?>
...
<div class="card card-custom mb-2">
    <div class="card-header card-header-tabs-line">
        <div class="card-title">
            <h3 class="card-label"><?php echo e(__('words.edit_photo')); ?></h3>
        </div>
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old($locale . '.title', $photo->translate($locale)->title)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="<?php echo e($locale . '[title]'); ?>" placeholder="<?php echo e(__('words.title')); ?>"
                            class="form-control  pl-5 min-h-40px <?php $__errorArgs = [$locale . '.subtitle'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old($locale . '.subtitle', $photo->translate($locale)->subtitle)); ?>">
                        <?php $__errorArgs = [$locale . '[subtitle]'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?> "
                        ...
                        rows="4"><?php echo e(old($locale . '.description', $photo->translate($locale)->description)); ?> </textarea>
...
<div class="card card-custom">
    <div class="card-body">
        ...
        <div class="form-group row col-6">
            <label for="exampleSelectd"><?php echo e(__('words.project')); ?></label>
            <select class="form-control" id="exampleSelectd" name="category_id">
                <option value="<?php echo e($myProject->id); ?>"><?php echo e($myProject->name); ?></option>
                <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($myProject->id != $project->id): ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\BasketBall\backend\resources\views/admin/photos/edit.blade.php ENDPATH**/ ?>