...
<div class="card card-custom card-stretch gutter-b">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-7 bg-light p-5 rounded h-100">
                            ...
                            <p class="m-0">{{ $project->translate($locale)->name }}</p>
                        </div>
                    </div>
    ...
    <div class="card card-custom">
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 ">
                                            <a href="{{$project->cover}}" data-toggle="lightbox"
                                                data-title="{{$project->title}}" data-gallery="gallery">
                                                <img src="{{$file->image}}" class="img-fluid mb-2 image-galley"
                                                    alt="product image" />
                                            </a>
                                        </div>
                                        @endforeach
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-4">
                    <a href="{{route('projects.edit',$project->id)}}" class="btn btn-block btn-outline-info">
                        {{__('words.edit')}}
                    </a>
                </div>
            </div>
