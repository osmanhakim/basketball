...
@section('title', settings()->website_title . ' | ' . __('words.projects'))
@section('breadcrumb')
<div class="d-flex align-items-baseline flex-wrap mr-5">
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item">
            <span class="text-muted">{{ __('words.show_projects') }}</span>
        </li>
    </ul>
    <!--end::Breadcrumb-->
</div>
...
<div class="card card-custom">
    <div class="card-header flex-wrap py-5">
        <div class="card-title">
            <h3 class="card-title">{{ __('words.show_projects') }}</h3>
        </div>
                ...
                <tr>
                    ...
                    <!-- <td>
                        ...
                        <a href="{{asset('uploads/default_image.png')}}" data-toggle="lightbox"
                            data-title="{{$project->title}}" data-gallery="gallery">
                        ...
                        @else
                        <a href="{{$project->cover}}" data-toggle="lightbox" data-title="{{$project->title}}"
