...
<div class="d-flex align-items-baseline flex-wrap mr-5">
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item">
            <span class="text-muted">{{ __('words.edit_project') }}</span>
        </li>
    </ul>
    <!--end::Breadcrumb-->
</div>
            ...
            <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}" role="tabpanel">
                <div class="col form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="{{ $locale . '[name]' }}" placeholder="{{ __('words.name') }}"
                            ...
                            value="{{ old($locale . '.name', $project->translate($locale)->name) }}">
                        @error($locale . '[name]')
                ...
                <!-- <div class="col form-group">
                            ...
                            <textarea class="form-control ckeditor @error($locale . '.description') is-invalid @enderror " type="text"
                                name="{{ $locale . '[description]' }}" rows="4">{{ old($locale . '.description', $project->translate($locale)->description) }} </textarea>
                                    ...
                                    <div class="col-md-3">
                                        <div class="rounded border m-1">
                                            <div>
                                                ...
                                                <img src="{{ $file->image }}" class="img-fluid mb-2 w-100 image-galley"
                                                    alt="product image" />
