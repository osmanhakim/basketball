...
@section('title', settings()->website_title . ' | ' . __('words.create_photo'))
@section('breadcrumb')
<div class="d-flex align-items-baseline flex-wrap mr-5">
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item">
            <span class="text-muted">{{ __('words.create_photo') }}</span>
        </li>
    </ul>
    <!--end::Breadcrumb-->
</div>
...
@section('form_action', route('photos.store'))
...
<div class="card card-custom mb-2">
    <div class="card-header card-header-tabs-line">
        <div class="card-title">
            <h3 class="card-label">{{ __('words.create_photo') }}</h3>
        </div>
            ...
            <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}" role="tabpanel">
                ...
                <div class="col form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="{{ $locale . '[subtitle]' }}" placeholder="{{ __('words.sub_title') }}"
