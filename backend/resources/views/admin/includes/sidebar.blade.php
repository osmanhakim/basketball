    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item menu-item-submenu {{ request()->routeIs('photos.*') ? 'menu-item-open menu-item-here' : '' }}"
                    aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <i class="fab fa-product-hunt svg-icon menu-icon"></i>
                        <span class="menu-text">{{ __('words.photos') }}</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
                        <ul class="menu-subnav">
                            ...
                            @permission('read-photos')
                            <li class="menu-item  {{ request()->routeIs('photos.index') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                            ...
                            <li class="menu-item  {{ request()->routeIs('photos.create') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                ...
                {{-- about routes start --}}
                @permission('read-abouts')
                <li class="menu-item menu-item-submenu {{ request()->routeIs('abouts.*') ? 'menu-item-open menu-item-here' : '' }}"
                    aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <i class="fa-solid fa-web-awesome svg-icon menu-icon"></i>
                        <span class="menu-text">{{ __('words.abouts') }}</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
                        <ul class="menu-subnav">
                            ...
                            @permission('read-abouts')
                            <li class="menu-item  {{ request()->routeIs('abouts.index') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                            ...
                            @permission('create-abouts')
                            <li class="menu-item  {{ request()->routeIs('abouts.create') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
