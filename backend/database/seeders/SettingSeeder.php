    ...
    public function run()
    {
        $setting = Setting::create([
            'ar' => [
                ...
                'about_name_first_country' => 'مصر',
                'about_address_first_country' => 'القاهرة مصر',
                'about_name_second_country' => 'السعودية',
                'about_address_second_country' => 'الرياض السعودية',
            ],
            'en' => [
                ...
                'about_name_first_country' => 'United States',
                'about_address_first_country' => '201 Oak Street 27 Manchester, USA',
                'about_name_second_country' => 'Australia',
                'about_address_second_country' => '201 Oak Street 27 Manchester, USA',
            ],
            'about_phone_first_country' => '+(34) 609 33 17 54',
            'about_email_first_country' => 'email@website.com',
            'about_phone_second_country' => '+(34) 609 33 17 54',
            'about_email_second_country' => 'email@website.com',
